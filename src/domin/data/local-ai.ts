    ...
    popularModels: [
      {
        ...
        capabilities: ["text", "vision", "audio"],
        size: "5.6 GB",
        description: "Google's April 2026 sweet spot. Native Audio ASR/Translation + Vision. Perfect for M4 MacBooks.",
      },
      {
        name: "Qwen 3.6-Plus",
        capabilities: ["text", "vision"],
        size: "24B",
        description: "Alibaba's April 2026 flagship. State-of-the-art coding and multimodal understanding.",
      },
      {
        name: "Llama 4 Maverick",
        capabilities: ["text"],
        size: "80B",
        description: "Meta's legendary reasoning model (2025). Highly reliable for complex agentic workflows.",
      },
      {
        name: "DeepSeek V4-Lite",
        capabilities: ["text"],
        size: "16B",
        description: "Fast reasoning model from the DeepSeek family, optimized for 2026 hardware.",
      },
      {
        name: "Gemma 4 E2B",
        capabilities: ["text", "vision", "audio"],
        size: "3.6 GB",
        description: "Ultra-fast multimodal inference. Runs perfectly on 16GB RAM devices.",
      },
    ],
    features: [
