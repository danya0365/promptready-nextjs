      ...
      <div className="max-w-[900px] mx-auto">
        ...
        <div className="relative glass rounded-3xl px-8 py-14 text-center mb-16 overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="mx-auto max-w-lg text-base text-text-secondary leading-relaxed">
              Complete every phase before prompting &mdash; so AI output stays
        ...
        <div className="glass rounded-2xl border-l-[3px] border-l-warning px-6 py-5 mb-12">
          ...
          <p className="text-sm leading-relaxed text-text-secondary">
            AI has no memory between sessions &mdash; every new prompt starts
            from zero. Without complete context, AI guesses everything:
            libraries, patterns, naming conventions. The result is code that
            looks different every time even with the same prompt.{" "}
        ...
        {/* Phases */}
        {WORKFLOW_PHASES.map((phase: WorkflowPhase, i: number) => (
          <WorkflowPhaseCard
            key={phase.id}
            phase={phase}
            defaultOpen={i === 0}
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <WorkflowCodeBlock code={AI_PROMPT_TEMPLATE} />
        </div>
      </div>
    </section>
  );
